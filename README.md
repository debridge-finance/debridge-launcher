...
12. Run `docker-compose exec ipfs_daemon ipfs bootstrap add "/ip4/139.59.164.64/tcp/4002/p2p/QmNN6JwFwEyhTALAphnuLNmUsD1VNLiiQheGoXbLp226xE"` comman that will add pinner node address to the ipfs bootstrap list.
